...
expName = 'templeton_exp2A_SD67_fMRI_training'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\micro\\OneDrive - NYU Langone Health\\Temp2A_fMRI_pilot_V3_training\\templeton2A_SD67_TRAINING.py',
...
static_instruction_2 = visual.TextStim(win=win, name='static_instruction_2',
    text='Press any button to continue and  see an example of how these groups of pictures look.',
    font='Arial',
    units='norm', pos=(0, -0.5), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
static_instruction_4 = visual.TextStim(win=win, name='static_instruction_4',
    text='Please press any button for more instructions.',
    font='Arial',
    units='norm', pos=(0, -0.75), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
static_instruction_28 = visual.TextStim(win=win, name='static_instruction_28',
    text='Please press any button to see more instructions.',
    font='Arial',
    units='norm', pos=(0, -0.5), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
static_instruction_32 = visual.TextStim(win=win, name='static_instruction_32',
    text='Please press any button to begin the practice trials.',
    font='Arial',
    units='norm', pos=(0, -0.5), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
static_instruction_30 = visual.TextStim(win=win, name='static_instruction_30',
    text='Please press any button to start.',
    font='Arial',
    units='norm', pos=(0, -0.5), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
static_instruction_43 = visual.TextStim(win=win, name='static_instruction_43',
    text='Please press any button to try out this strategy during a few training trials.',
    font='Arial',
    units='norm', pos=(0, -0.5), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
short_retint=0.75
varying_long_retints=[1.6+0.2*counter for counter in range(11)]
short_block_done = 0
...
for thisTrial_10 in trials_10:
    ...
    while continueRoutine:
        ...
        if sd_training_resp.status == STARTED and not waitOnFlip:
            theseKeys = sd_training_resp.getKeys(keyList=['6', '7'], waitRelease=False)
        ...
        if len(sd_training_resp.keys):
            if(short_block_done == 0):
                if(retro_0_post_1_training[training_trial_index] == 0):
                    if (change_or_no_training == 0) and (sd_training_resp.keys == '6'):
                        consecutive_correct_retro=consecutive_correct_retro+1
                    else:
                        if (change_or_no_training == 1) and (sd_training_resp.keys == '7'):
                            consecutive_correct_retro=consecutive_correct_retro+1
                        else:
                            consecutive_correct_retro=0
                ...
                if(retro_0_post_1_training[training_trial_index] == 0):
                    ...
                    elif (change_or_no_training == 1) and (sd_training_resp.keys == '7'):
                        correct_retro_long_perblock=correct_retro_long_perblock+1
    ...
    while continueRoutine:
        ...
        if conf_training_resp.status == STARTED and not waitOnFlip:
            theseKeys = conf_training_resp.getKeys(keyList=['1', '2', '3'], waitRelease=False)
    ...
    if (short_block_done == 0) and (consecutive_correct_retro == consecutive_retro_correct_required):
        ...
        consecutive_correct_retro = 0
        short_block_done = 1
    #elif (short_block_done == 0) and (training_trial_index>=max_num_training_trials):
    ...
    if (short_block_done):
        ...
        if (training_trial_index_long>0) and (mod(training_trial_index_long,trials_long_perblock) == 0):
            thisExp.addData('finish_training_early',0)
            ...
            if(long_block_retro_acc >= 0.8):
                ...
                correct_retro_long_perblock = 0
                retro_trials_long_perblock = 0
        elif (training_trial_index>=max_num_training_trials) and (long_block_retro_acc<0.8):
            thisExp.addData('finish_training_early',1)
            win.close()
            core.quit()
